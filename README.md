...
Este repositório contém as atividades e exercícios desenvolvidos ao longo do semestre para a disciplina de Programação de Scripts.
...
This repository contains the activities and exercises developed throughout the semester for the Script Programming course.

📝 Language: HTML/CSS/JavaScript 💻 IDE: VS Code
